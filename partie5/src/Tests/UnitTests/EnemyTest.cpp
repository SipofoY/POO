...
SCENARIO("Ant vs Ant", "[AntWorker][AntSoldier")
{
    ...
    Vec2d pos(0,0);
    colony1.push_back(new AntSoldier(pos, id1));
    colony1.push_back(new AntWorker(pos, id1));
    colony2.push_back(new AntSoldier(pos, id2));
    colony2.push_back(new AntWorker(pos, id2));
...
SCENARIO("Ant vs Termite", "[AntWorker][AntSoldier][Termite")
{
    ...
    colony2.push_back(new AntSoldier(pos, id2));
    colony2.push_back(new AntWorker(pos, id2));
    termites.push_back(new Termite(pos2));
    termites.push_back(new Termite(pos2));
