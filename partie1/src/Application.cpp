...
#include <algorithm>
#include <cassert>
//#include <Stats/Stats.hpp> // utilisé dans les étapes ultérieures
#include "Config.hpp"
namespace // anonymous
{
...
{
    // Destroy environment and stats, in reverse order
//    delete mEnv;
	delete mConfig;
//	delete mStats;
...
//						mStats->next();
    ...
    //         auto* ant = getEnv().getAnimalAt(pos);
    //         if (ant == nullptr) {
    //             // Stop tracking animal
    //             getAnimalTracker().stopTrackingAnimal();
    //         } else {
    //             // Track the animal
    //             getAnimalTracker().startTrackingAnimal(ant);
    //         }
    //     }
    //     break;
