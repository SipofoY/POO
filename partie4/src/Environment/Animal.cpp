...
Animal::Animal(double pointvie1, Vec2d position1) //???
    ...
    :Animal(pointvie1, getAppConfig().animal_default_lifespan, position1, 0)

{}
Animal::Animal(double pointvie1, int esperancevie1, Vec2d position1, Angle direction1)
    :Animal(pointvie1,esperancevie1, position1){
